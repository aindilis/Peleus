...
/usr/lib/jvm/adoptopenjdk-16-hotspot-amd64/bin/java -cp ./lib/peleus.jar:./lib/jemplan.jar:./lib/jason.jar jason.infra.centralised.RunCentralisedMAS examples/softbot/Softbot.mas2j -debug
